...
El backend usa `s3:ListBucket` para mostrar en el panel las imágenes existentes de `categories/` y `brands/`. La subida y eliminación requieren permisos sobre objetos del bucket.
